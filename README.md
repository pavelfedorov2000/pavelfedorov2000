...
<h3 align="center">Front-end developer from Minsk, Belarus</h3>

Specializing mostly in layouting (HTML5 / CSS3 / SCSS (Sass) / JS / Jquery, semantics, flex / grid, BEM) - middle level. As for frontend framework - it's React.js, I really like it's philosophy.

Technologies that I currently know:
